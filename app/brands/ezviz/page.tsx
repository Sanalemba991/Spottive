...
const banner = {
  ...
  title: 'EZVIZ',
  tagline: 'Protecting Your Moments with Smart Simplicity.',
  buttons: [
    { text: 'Discover Products', variant: 'solid' },
    { text: 'Support', variant: 'outline' }
  ],
  image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=1920&q=80', // Smart camera/home themed image
};
      ...
      >
        ...
        >
          ...
          >
            ...
            <strong className='text-cyan-700'>Spottive Technologies</strong>, You&apos;re Not Just Opting For A Product; You&apos;re
